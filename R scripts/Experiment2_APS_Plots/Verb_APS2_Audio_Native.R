...
# R codes--ERP plot for the target verbs in Experiment 2 Native APS condition
...
cond2<-read.csv("APS2_Bin2_English incorrect Verb in Good Pronoun.csv",sep=",", comment.char ="", quote='"', na.strings ="", header=T)
names(cond1)
names(cond2)
...
# Save plot as pdf
dev.copy(pdf, "APS2 Verb English_colorless.pdf", width=7.5, height=9)
dev.off()
