...
# R codes--the ERP plot for the verbs in Experiment 2 Non-native APS condition
# The figure presents the readers' responses to grammtical verbs and ungrammtical verbs 
...
cond2<-read.csv("APS2_Bin4_Chinese incorrect Verb in Good Pronoun.csv",sep=",", comment.char ="", quote='"', na.strings ="", header=T)
...
# Create a legend. Change as is appropriate for your experiment.
#legend("bottomright", c(cond1_name, cond2_name), lwd=line_width, col=c(cond1_color, cond2_color), lty=c(cond1_type, cond2_type))


# Save plot as pdf
dev.copy(pdf, "APS2 Verb Chinese_colorless.pdf", width=7.5, height=9)
dev.off()
